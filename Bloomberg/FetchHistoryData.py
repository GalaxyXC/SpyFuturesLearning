...
def FetchHistoryData(SEC, StartAt, EndAt):
    ...
    try:
        ...
        request.getElement("fields").appendValue("PX_LAST") # CLOSE
        ...
        request.set("startDate", StartAt)
        request.set("endDate", EndAt)
        ...
        filename = "FetchedHistory/" + security + "_1986_2017.txt"
...
if __name__ == "__main__":
    ...
    try:
        # main()
        FetchHistory("AAPL UW Equity", "20060101", "20171231")  # <<<<<<<<<<<<<<<<<<<<<<< EQUITY NAMES HERE
